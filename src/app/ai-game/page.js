        ...
        {!selectedModel ? (
          ...
          <div className="grid grid-cols-2 gap-8">
            ...
            >
              ...
              />
              <p className="text-center mt-4">Google NotebookLM</p>
            </motion.div>
            <motion.div
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            ...
            >
              <Image
                ...
                className="rounded-full mx-auto"
              />
              <p className="text-center mt-4">ChatGPT</p>
            </motion.div>
            <motion.div
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            ...
            >
              <Image
                ...
                className="rounded-full mx-auto"
              />
              <p className="text-center mt-4">Claude</p>
            </motion.div>
            <motion.div
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            ...
            >
              <Image
                ...
                className="rounded-full mx-auto"
              />
              <p className="text-center mt-4">Microsoft CoPilot</p>
            </motion.div>
          </div>
        ) : (
