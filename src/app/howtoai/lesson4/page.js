    ...
    return (
        ...
        <div className="max-w-4xl mx-auto p-6">
          ...
          <section className="mb-8 bg-blue-50 p-4 rounded-lg border border-blue-200 text-gray-800">
            ...
            <p className="mt-2">
              By the end of this lesson, you'll be able to use Google Co-Pilot to enhance your collaborative work processes and automate tasks in an efficient way.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
                Once you've signed in, you will be directed to the main Google Co-Pilot interface, as shown below:
            </p>
            ...
            <section className="mb-8">
  <h2 className="text-3xl font-bold mb-6 text-sky-500 border-b-2 border-sky-300 pb-2">
    Step 3: Co-Pilot's Response with Links and Images
  </h2>
  <p className="mb-4">
  ...
  <div className="flex flex-col md:flex-row items-center md:items-start gap-6 my-6">
    ...
    <div className="w-full md:w-1/2">
      <p>
        ...
        These helper links are great for expanding on the topic you're exploring.
      </p>
    </div>
  </div>
...
<section className="mb-8">
  <h2 className="text-3xl font-bold mb-6 text-sky-500 border-b-2 border-sky-300 pb-2">
    Step 4: Exploring Co-Pilot's Interactive Features
  </h2>
  <p className="mb-4">
...
<section className="mb-8">
  ...
  <div className="flex flex-col md:flex-row items-center md:items-start gap-6 my-6">
    ...
    <div className="w-full md:w-1/2">
      <p>
        As shown in the image, you can download the app by scanning the QR code, or by visiting your phone's app store to search for "Google Co-Pilot." The app provides AI-powered chat capabilities that make it easy to interact with Co-Pilot wherever you are.
      </p>
      <p className="mt-4">
...
<section className="mb-12">
  ...
  <p className="mb-4 text-lg">
    Great job! You've successfully learned how to navigate and use Google Co-Pilot. You're now equipped to take full advantage of its AI-powered features for your tasks and projects.
  </p>

  <p className="mb-4 text-lg">
    Ready to test your knowledge? Take the AI quiz and challenge yourself on what you've learned so far!
  </p>
